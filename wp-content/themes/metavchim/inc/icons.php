...
function mv_icon_path( $name ) {
	$icons = array(
		...
		'signature' => '<path d="M3.6 16.8c2.5.4 3.3-2.7 4.9-5.8 1.4-2.7 2.6-1.5 2.2 1-.3 1.9 1 2.6 2.2 1.3 1.1-1.2 2.4-1 2.8.5.3 1.2 1.3 1.7 2.4 1.2"/><path d="M4 20.4h16"/>',
		'inbox'     => '<path d="M5.2 5h13.6l2.2 7.6V18a1.8 1.8 0 0 1-1.8 1.8H4.8A1.8 1.8 0 0 1 3 18v-5.4L5.2 5Z"/><path d="M3 12.6h4.6l1.4 2.6h6l1.4-2.6H21"/>',
		'search'    => '<circle cx="10.8" cy="10.8" r="6.3"/><path d="m15.4 15.4 4.3 4.3"/>',
		'shield'    => '<path d="M12 3.4 19 6v6c0 4-2.9 7-7 8.6C7.9 19 5 16 5 12V6l7-2.6Z"/><path d="m9.2 12 2.1 2.1L15.1 10"/>',
		'access'    => '<circle cx="12" cy="4.4" r="1.8"/><path d="M4.8 8.2c2.3.9 4.6 1.4 7.2 1.4s4.9-.5 7.2-1.4"/><path d="M12 9.6v4.4m0 0-2.8 5.6m2.8-5.6 2.8 5.6"/>',
		'megaphone' => '<path d="M4 10.4v3.2a2 2 0 0 0 2 2h1.6L15 19V5L7.6 8.4H6a2 2 0 0 0-2 2Z"/><path d="M18.6 9.4a4 4 0 0 1 0 5.2"/><path d="M8.6 15.8 9.8 20"/>',
		'tasks'     => '<path d="m3.8 6.6 1.5 1.5 2.6-2.6"/><path d="m3.8 12.6 1.5 1.5 2.6-2.6"/><path d="m3.8 18.6 1.5 1.5 2.6-2.6"/><path d="M11.6 6.6h8.6M11.6 12.6h8.6M11.6 18.6h8.6"/>',
		'gauge'     => '<path d="M4.4 17.4a8 8 0 1 1 15.2 0"/><path d="m12 13.6 3.6-3.8"/><path d="M12 17.4h.01"/>',
