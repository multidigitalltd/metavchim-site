...
function mv_theme_pages() {
	return array(
		...
		'marathon'      => array(
			'title'   => 'מרתון השת״פים למתווכות',
			'content' => 'mv_get_event_content',
			'excerpt' => 'בוקר עבודה אחד למתווכות: מעלות למערכת את הנכסים והקונים שיש לכן ביד, המערכת מצליבה בין כל מי שנמצאת בחדר, ואתן סוגרות שיתופי פעולה בלייב — עם הסכם עמלה כתוב.',
		),
		'privacy'       => array(
			'title'   => 'פרטיות',
